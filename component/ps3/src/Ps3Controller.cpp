...
void Ps3Controller::setRumble(float intensity, int duration) {
    ...
    uint8_t raw_intensity = 128; // @TODO map(constrain(intensity, int_min, int_max), int_min, int_max, 0, 255);
    uint8_t raw_duration = 127; // @TODO map(constrain(duration, dur_min, dur_max), dur_min, dur_max, 0, 254);
